...
-- Miscellaneous 
vim.cmd("Plug 'nvim-treesitter/nvim-treesitter', {'do': ':TSUpdate'}") -- Better syntax highlighting
...
Plug 'Wansmer/treesj' -- Easily turn arrays/functions into multiple lines or vice versa with :TSJToggle (Broken)
